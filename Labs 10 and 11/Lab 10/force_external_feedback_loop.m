...
%Train/test data or check weights of echo network
trainTestdat=0; %1 - train/test data; 0 - check weights of echo network
...
%Look at weights during first 100 data points
hold all; 
for i=1:N
    plot(W(i,1:100));
end
